...
class MediaAttachment < ApplicationRecord
  ...
  IMAGE_LIMIT = (ENV['MAX_IMG_SIZE'] || 10).to_i.megabytes
  VIDEO_LIMIT = (ENV['MAX_VID_SIZE'] || 40).to_i.megabytes

  MAX_VIDEO_MATRIX_LIMIT = (ENV['MAX_VIDEO_MATRIX_LIMIT'] || 2_304_000).to_i   # 1920x1200px
  MAX_VIDEO_FRAME_RATE   = (ENV['MAX_VIDEO_FRAME_RATE'] || 60).to_i
  ...
  IMAGE_STYLES = {
    original: {
      pixels: (ENV['MAX_IMAGE_MATRIX_SIZE'] || 2_073_600).to_i, # 1920x1080px
  ...
  GLOBAL_CONVERT_OPTIONS = {
    all: '-quality 90 -strip +profile "!icc,*" +set date:modify +set date:create +set date:timestamp',
  }.freeze
